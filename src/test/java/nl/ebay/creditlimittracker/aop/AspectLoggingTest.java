package nl.ebay.creditlimittracker.aop;
...
//TODO : Keep micro nl.jumbo.storemanager.service specific test cases after split
@ExtendWith(MockitoExtension.class)
class AspectLoggingTest implements WithBDDMockito {
    ...
    void testLogControllers() throws Throwable {
        // given
        request.setRequestURI("/stores/12341234");
    ...
    @Test
    @DisplayName("Should log game nl.jumbo.storemanager.service method enter and exit logs when log level is debug and no exception thrown by the method")
    void test_log_backend_service() throws Throwable {
        // given
        request.setRequestURI("/stores");
        request.setMethod("GET");
    ...
    @Test
    @DisplayName("Should not log backend nl.jumbo.storemanager.service method enter and exit logs when log level is info and no exception thrown by the method")
    ...
    @Test
    @DisplayName("Should not log backend nl.jumbo.storemanager.service method enter and exit/exception logs when log level is debug and exception thrown by the method")
